...
This package includes some utilities used for scaffolding node projects base on [Create React App](https://github.com/facebookincubator/create-react-app).<br>
