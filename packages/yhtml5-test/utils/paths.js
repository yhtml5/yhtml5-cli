...
// config before publish: we're in ./packages/2d-test/utils/
const isBeforePublish = !reactScriptsLinked &&
  __dirname.indexOf(path.join('packages', '2d-test', 'utils')) !== -1
...
isBeforePublish && console.log('\npaths.js\n', {
  ...
  reactScriptsLinked,
  isBeforePublish,
  isBeforePublishPath: path.join('packages', '2d-test', 'utils'),
